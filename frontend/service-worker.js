...
const CACHE_NAME = "sevahealth-v3.9.0-clean";
const ASSETS_TO_CACHE = [
  ...
  "/referrals.html",
  "/followups.html",
  "/css/style.css?v=3.9.0",
  "/images/login-bg.jpg",
  "/images/header-banner.jpg?v=3.9.0",
  "/js/api.js?v=3.9.0",
  "/js/auth.js?v=3.9.0",
  "/js/i18n.js?v=3.9.0",
  "/js/offline.js?v=3.9.0",
  "/js/triage.js?v=3.9.0",
  "/js/dashboard.js?v=3.9.0",
  "/js/patient.js?v=3.9.0",
  "/js/doctor.js?v=3.9.0",
  "/js/specialist.js?v=3.9.0",
  "/js/referrals.js?v=3.9.0",
  "/js/followups.js?v=3.9.0",
  "/manifest.json",
  "/icons/icon-192.png",
  "/icons/icon-512.png",
...
self.addEventListener("install", (event) => {
  ...
  event.waitUntil(
    caches.open(CACHE_NAME).then((cache) => {
      console.log("[Service Worker] Caching New Application Shell Assets v3.9.0");
